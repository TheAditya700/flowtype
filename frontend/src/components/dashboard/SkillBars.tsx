    ...
    <div className="w-full bg-gray-900 rounded-xl p-6 border border-gray-800 h-full flex flex-col justify-between">
      ...
      <div className="mb-0">
        ...
        <div className="flex items-baseline gap-3 mb-4">
          <p className="text-9xl font-bold text-emerald-500 font-mono">
        ...
        {/* Consistency */}
        <div className="flex items-baseline gap-3 mb-4">
          <p className="text-9xl font-bold text-blue-500 font-mono">
        ...
        {/* Speed */}
        <div className="flex items-baseline gap-3 mb-4">
          <p className="text-9xl font-bold text-purple-500 font-mono">
            {Math.round(speed)}
          </p>
        ...
        {durationSeconds !== undefined && (
          <div className="flex items-baseline gap-3">
            <p className="text-9xl font-bold text-white font-mono">
