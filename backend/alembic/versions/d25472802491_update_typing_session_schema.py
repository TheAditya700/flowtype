...
def upgrade() -> None:
    ...
    # Add new columns
    op.add_column(
        "typing_sessions", sa.Column("user_embedding", sa.JSON(), nullable=True)
    )
    op.add_column(
        "typing_sessions",
        sa.Column("snippet_ids", sa.JSON(), nullable=False, server_default="[]"),
    )
    op.add_column(
        "typing_sessions", sa.Column("snippet_embeddings", sa.JSON(), nullable=True)
    )
    op.add_column(
        "typing_sessions",
        sa.Column("keystroke_events", sa.JSON(), nullable=False, server_default="[]"),
    )
    op.add_column("typing_sessions", sa.Column("actual_wpm", sa.Float(), nullable=True))
    op.add_column(
        "typing_sessions", sa.Column("actual_accuracy", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("actual_consistency", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("predicted_wpm", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("predicted_accuracy", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("predicted_consistency", sa.Float(), nullable=True)
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "typing_sessions", sa.Column("avg_difficulty", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("ending_difficulty", sa.Float(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("starting_difficulty", sa.Float(), nullable=True)
    )
    ...
    op.add_column(
        "typing_sessions", sa.Column("backspaces", sa.Integer(), nullable=True)
    )
    op.add_column(
        "typing_sessions", sa.Column("words_typed", sa.Integer(), nullable=True)
    )
