...
from app.routers import health, snippets, sessions, users, auth, analytics
...
app.include_router(analytics.router, prefix="/api/analytics", tags=["analytics"]) # Register analytics
